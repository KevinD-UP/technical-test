...
class Operation(models.Model):
    ...
    longitude = models.DecimalField(max_digits=100, decimal_places=90, default=0.0)
    ...
    latitude = models.DecimalField(max_digits=100, decimal_places=90, default=0.0)
    ...
    enveloppe_prev_en_meu = models.DecimalField(max_digits=100, decimal_places=90, default=0.0)